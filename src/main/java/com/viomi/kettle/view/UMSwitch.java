 ...
 *	@author Wison
 */
public class UMSwitch extends CompoundButton {
    ...
    private int sliderPadding=5;//中间滑块相对于轨道间距
...
//    @SuppressWarnings("hiding")
     ...
     */
    public UMSwitch(Context context, AttributeSet attrs) {
     ...
     */
    public UMSwitch(Context context, AttributeSet attrs, int defStyle) {
...
//    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mThumbDrawable.getPadding(mTempRect);
        int padding=(int)(mTextPaint.density*sliderPadding);
        final int thumbPos = (int) (mThumbPosition + 0.5f);
        int thumbLeft = switchInnerLeft - mTempRect.left + thumbPos+padding;
        int thumbRight = switchInnerLeft + thumbPos + mThumbWidth + mTempRect.right-padding;
        switchTop+=padding;
        switchBottom-=padding;
